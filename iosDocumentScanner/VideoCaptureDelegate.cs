...
namespace iosDocumentScanner {
	...
	/// </summary>
	public class VideoCaptureDelegate : NSObject, IAVCaptureVideoDataOutputSampleBufferDelegate , IAVCapturePhotoCaptureDelegate
	{

		DateTime lastAnalysis = DateTime.Now;  // controlling the pace of the machine vision analysis
		TimeSpan pace = new TimeSpan (0, 0, 0, 0, 100); // in milliseconds, classification will not repeat faster than this value
		...
		// This could be called when the user taps a button to capture the image
